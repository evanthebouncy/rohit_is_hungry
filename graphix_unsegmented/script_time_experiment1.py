...
#  print "time_nn: ", i_nn_params['building_time'], i_nn_params['solving_time'], i_nn_params['ce_size'], i_nn_params['nn_time']
  print "time_cegis: ", i_cegis_params['building_time'], i_cegis_params['solving_time'], i_cegis_params['checking_time'], i_cegis_params['ce_size']
#  print "time_rcegis: ", i_rcegis_params['building_time'], i_rcegis_params['solving_time'], i_rcegis_params['ce_size']
  print "time_acegis: ", i_acegis_params['building_time'], i_acegis_params['solving_time'], i_acegis_params['checking_time'], i_acegis_params['ce_size']
#  print "time_rand_cegis: ", i_rand_cegis_params['building_time'], i_rand_cegis_params['solving_time'], i_rand_cegis_params['ce_size']
  print "time_nn_cegis: ", i_nn_cegis_params['building_time'], i_nn_cegis_params['solving_time'], i_nn_cegis_params['checking_time'], i_nn_cegis_params['nn_time'], i_nn_cegis_params['ce_size'], i_nn_cegis_params['error'] / 1024, i_nn_cegis_params['orig_subset_size']

  print "did we win {}, {}, {}".format(i_cegis_params['building_time']+i_cegis_params['solving_time']+i_cegis_params['checking_time'],
                                       i_acegis_params['building_time']+i_acegis_params['solving_time']+i_acegis_params['checking_time'],
                                       i_nn_cegis_params['building_time']+i_nn_cegis_params['solving_time']+i_nn_cegis_params['checking_time'])
